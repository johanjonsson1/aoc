    ...
    */
    public class Day4 : Day
    {
        ...
        public override void PartOne()
        {
            ...
            realRooms = rooms.Where(x => !x.IsDecoy).ToList();
            Console.WriteLine(realRooms.Sum(s => s.Id));
        }

        public override void PartTwo()
        {
            base.PartTwo();
            var northPoleRooms = realRooms.Where(x => x.DecryptedName.Contains("north")).ToList();
        ...
        public class Room
        {
            ...
            private static string Substitution = "bcdefghijklmnopqrstuvwxyza";
            ...
            private string DecryptName()
            {
                ...
                while(!char.IsDigit(currentChar))
                {
                    ...
                    else
                    {
                        ...
                        while(j < Id)
                        {
                            var index = Alphabet.IndexOf(tempChar);
                            tempChar = Substitution[index];
                            j++;
                        }
