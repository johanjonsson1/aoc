...
namespace AoC_2016
{
    ...
    public class Day1 : Day
    {
        ...
        public override void PartOne()
        {
            ...
            var input = Inputs.Day1.Split(new string[] { ",", " " }, StringSplitOptions.RemoveEmptyEntries);
    ...
    public class Navigator
    {
        ...
        public void Move(string instruction, bool track = false)
        {
            ...
            while(newX != CurrentCoordinate.X || newY != CurrentCoordinate.Y)
            {
                ...
                if (!TwiceFound && VisitedCoordinates.Contains(newCoordinate))
                {
