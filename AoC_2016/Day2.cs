...
namespace AoC_2016
{
    ...
    */
    public class Day2 : Day
    {
        ...
        private static List<Button> KeyPad = new List<Button>
        {
        ...
        private static List<Button> SpecialKeyPad = new List<Button>
        {
            new Button { NumberOrChar = "5", Coordinate = new Coordinate(0,0)},
            new Button { NumberOrChar = "6", Coordinate = new Coordinate(1,0)},
        ...
        public override void PartOne()
        {
            ...
            KeypadInstruction.KeyPad = KeyPad;
            KeypadInstruction.CurrentButton = KeyPad.FirstOrDefault(x => x.NumberOrChar == "5");
...
//UUUUD".ToStringList();
            var instructions = Inputs.Day2.ToStringList();
            KeypadInstruction.KeyPad = SpecialKeyPad;
            KeypadInstruction.CurrentButton = KeyPad.FirstOrDefault(x => x.NumberOrChar == "5");
            string result = TapKeys(instructions);
