...
namespace AoC_2018
{
    ...
    */
    ...
    {
        public override string Title => "2018 - Day 1: Chronal Calibration";

        public override void PartOne()
        {
            base.PartOne();
            Console.WriteLine(Inputs.Day1.SplitAsIntsBy(NewlineCarriageReturn).Sum()); // 576
        }
        ...
        public override void PartTwo()
        {
            ...
            Console.WriteLine(currentFrequency); // 77674
        }
    }
}
