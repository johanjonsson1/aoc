...
public class Cart
{
    ...
    private IntersectionChoice? _nextChoice = null;
    ...
    public void Move()
    {
        ...
        {
            _nextChoice = GetNext(_nextChoice);

            if (Facing == CartFacing.Left && _nextChoice == IntersectionChoice.Left)
            {
                Facing = CartFacing.Down;
            }
            else if (Facing == CartFacing.Left && _nextChoice == IntersectionChoice.Right)
            {
                Facing = CartFacing.Up;
            }
            else if (Facing == CartFacing.Up && _nextChoice == IntersectionChoice.Left)
            {
                Facing = CartFacing.Left;
            }
            else if (Facing == CartFacing.Up && _nextChoice == IntersectionChoice.Right)
            {
                Facing = CartFacing.Right;
            }
            else if (Facing == CartFacing.Right && _nextChoice == IntersectionChoice.Left)
            {
                Facing = CartFacing.Up;
            }
            else if (Facing == CartFacing.Right && _nextChoice == IntersectionChoice.Right)
            {
                Facing = CartFacing.Down;
            }

            else if (Facing == CartFacing.Down && _nextChoice == IntersectionChoice.Left)
            {
                Facing = CartFacing.Right;
            }
            else if (Facing == CartFacing.Down && _nextChoice == IntersectionChoice.Right)
            {
                Facing = CartFacing.Left;
            }
        }
