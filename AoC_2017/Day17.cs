...
namespace AoC_2017
{
    ...
    */
    ...
    {
        public override string Title => "--- Day 17: Spinlock ---";
        ...
        public override void PartOne()
        {
            ...
            {
                atIndex = buffer.GetNext(atIndex, input);
                var newIndex = atIndex + 1;
                buffer.Insert(newIndex, i);
                atIndex = newIndex;
            }

            var result = buffer.Items[buffer.Items.IndexOf(2017) + 1];
        ...
        public override void PartTwo()
        {
            base.PartTwo();
            var input = 329;
            //var buffer = new CircularList<int>(50_000_001);
            //buffer.Add(0);
            var atIndex = 0;
            ...
            {
                var newIndex = (atIndex + input) % (i + 1);
                if (newIndex == 0)
                {
                    result = i + 1;
                }
            ...
            //var result = buffer.Items[buffer.Items.IndexOf(0) + 1];
