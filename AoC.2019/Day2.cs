...
{
    public override string Title => "--- Day 2: 1202 Program Alarm ---";
    ...
    {
        base.PartTwo();
        var result = FindOutput19690720();
        Console.WriteLine("Result = " + result);
    }

    private static void LoopUntilHalt(List<int> input)
    {
        var index = 0;
        ...
        while (currentOpCode != 99)
        {
            ...
            input[storageIndex] = currentOpCode == 1 ? value1 + value2 : value1 * value2;
            index += 4;
            currentOpCode = input[index];
        }
    }

    private static int FindOutput19690720()
    {
