...
namespace AoC2019
{
    ...
    */
    ...
    {
        public override string Title => "--- Day 22: Slam Shuffle ---";
...
//cut -1".ToStringList();
        ...
        {
            base.PartTwo();
            // math savant puzzle, ignore..
            var deckSize = 119315717514047;
            var shuffleTimes = 101741582076661;
            Console.WriteLine();
        }

        private static List<int> DealIntoNewStack(List<int> before)
        {
        ...
        private static List<int> CutNCards(List<int> before, int cut)
        {
        ...
        private static List<int> DealWithIncrementN(List<int> before, int incr)
        {
