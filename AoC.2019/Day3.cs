    ...
    */
    ...
    public class Day3 : Day
    {
        ...
        public override void PartOne()
        {
            ...
            counter = 0;
            var navigator2 = new Navigator(new Coordinate(0, 0), Navigator.Face.Up);//Left
            ...
            var intersections = navigator.VisitedCoordinates.Where(x => !x.Equals(center))
                .Intersect(navigator2.VisitedCoordinates, Coordinate.CoordinateComparer).OrderBy(o => o.GetDistance(center));

            var coord1 = navigator.VisitedCoordinates.ToList();
            var coord2 = navigator2.VisitedCoordinates.ToList();

            var closest  = intersections.Select(o =>
            {
                return coord1.IndexOf(o) + coord2.IndexOf(o);
            }).OrderBy(i => i);
