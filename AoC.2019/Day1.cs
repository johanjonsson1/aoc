...
namespace AoC2019
{
    ...
    {
        public override string Title => "--- Day 1: The Tyranny of the Rocket Equation ---";

        public override void PartOne()
        {
            base.PartOne();

            var result = Inputs.Day1
                .SplitAsDoublesBy(NewlineCarriageReturn)
                .Select(s => Math.Floor(s / 3) - 2)
                .Sum();
