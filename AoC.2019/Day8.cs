...
namespace AoC2019
{
    ...
    So, the first digit corresponds to the top-left pixel of the first layer, the second digit corresponds to the pixel to the right of that on the same layer, 
    ...
    */
    ...
    {
        public override string Title => "--- Day 8: Space Image Format ---";
        ...
        public override void PartOne()
        {
            ...
            var orderedByFewest = layers
                .Select(s => s.Layer)
                .OrderBy(o => ImageLayers.CountDigit(o, '0'))
                .ToList();

            var first = orderedByFewest.First();
        ...
        public override void PartTwo()
        {
            ...
            var currentPos = 0;
            for (var y = 0; y < ImageLayers.Height; y++)
            {
                for (var x = 0; x < ImageLayers.Width; x++)
                {
